...
class FastRCNNPredictor_res50(nn.Module):
    """
    ...
    def __init__(self, in_channels, num_classes):
        super(FastRCNNPredictor_res50, self).__init__()
...
class FasterRCNN_res50(FasterRCNNBase):
    """
    ...
    def __init__(self, backbone, num_classes=None,
        ...
        super(FasterRCNN_res50, self).__init__(backbone, rpn, roi_heads, transform)
